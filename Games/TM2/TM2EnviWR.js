...
function showInfo(mapWR){
    ...
    WrStatLagoon.innerHTML = "> <span class='WrCount'>" + EnviWrCount["Lagoon"] + "</span> WR Archived";

    let WrStatStadium = document.getElementById("WrStatStadium");
    WrStatStadium.innerHTML = "> <span class='WrCount'>" + EnviWrCount["Stadium"] + "</span> WR Archived";

    let WrStatValley = document.getElementById("WrStatValley");
    WrStatValley.innerHTML = "> <span class='WrCount'>" + EnviWrCount["Valley"] + "</span> WR Archived";

    let WrStatCanyon = document.getElementById("WrStatCanyon");
    WrStatCanyon.innerHTML = "> <span class='WrCount'>" + EnviWrCount["Canyon"] + "</span> WR Archived";
}
