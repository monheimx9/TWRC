...
document.write(MapSelector(getUniqueColumn(rows, 1))); // le menu déroulant

document.write('<h1 class="output" id="output1">Map:</h1>')
...
// This is exectued only when the slect block changes value

function getSelectValue(){
    var selectedValue = document.getElementById("MapSelector").value; // Get the map that is selected
    out1.innerHTML = "Map: " +selectedValue; // Modify the map name displayed on screen
    LBtable.innerHTML = modifyTable(rows, selectedValue); // Modify what's inside the Table
}
